                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('update.profile') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="profile_picture" type="file" class="form-control @error('profile_picture') is-invalid @enderror" name="profile_picture" accept="image/*" onchange="previewImage(event)">
                            <img id="profile_picture_preview" src="{{ asset('storage/' . Auth::user()->profile_picture) }}" alt="Profile Picture" style="max-width: 200px; max-height: 200px;">
